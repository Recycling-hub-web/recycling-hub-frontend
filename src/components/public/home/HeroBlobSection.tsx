...
const GradientCard = ({ label }: { label: string }) => (
  <div
  ...
  >
    ...
    <span className="text-sm font-bold leading-snug sm:text-base">{label}</span>
  </div>
);
    ...
    <section className="relative overflow-hidden bg-white py-20 md:py-28">
      ...
      <div className="relative z-10 mx-auto mt-16 max-w-5xl px-5 md:mt-24 md:px-8">
        <div className="grid grid-cols-2 items-end gap-4 sm:grid-cols-3 md:grid-cols-5">
          <StatCard
            label={content.statCardLabel}
            value={content.statCardValue}
          />
          ...
          <GradientCard label={content.gradientCardLabel} />
        </div>
      </div>
    </section>
  );
