...
const Sidebar = ({ navItems, open, onClose }: SidebarProps) => {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed inset-y-0 start-0 z-50 flex h-screen w-64 shrink-0 flex-col border-e border-slate-200 bg-white shadow-sm transition-transform duration-200 ease-in-out lg:static lg:z-auto lg:w-60 lg:translate-x-0 ${
